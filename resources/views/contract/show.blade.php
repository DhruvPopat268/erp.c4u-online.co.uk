        ...
        <div class="col-lg-3 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('Last V5C Issued') }}</h6>
                    @if (!empty($contract->dateOfLastV5CIssued) && $contract->dateOfLastV5CIssued !== '-')
                        <h3 class="mb-0">{{ \Carbon\Carbon::parse($contract->dateOfLastV5CIssued)->format('d/m/Y') }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('MOT Expiry Date') }}</h6>
                    @if (!empty($vehicle->annual_test_expiry_date) && $vehicle->annual_test_expiry_date !== '-')
                        <h3 class="mb-0">{{ $vehicle->annual_test_expiry_date ? Carbon::parse($vehicle->annual_test_expiry_date)->format('d/m/Y') : 'N/A' }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('Road Tax Date') }}</h6>
                    @if (!empty($contract->taxDueDate) && $contract->taxDueDate !== '-')
                        <h3 class="mb-0">{{ $contract->taxDueDate ? Carbon::parse($contract->taxDueDate)->format('d/m/Y') : 'N/A' }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
        ...
        <div class="col-lg-4 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('Fridge Service') }}</h6>
                    @if (!empty($contract->fridge_service) && $contract->fridge_service !== '-')
                        <h3 class="mb-0">{{ \Carbon\Carbon::parse($contract->fridge_service)->format('d/m/Y') }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
        ...
        <div class="col-lg-4 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('Fridge Calibration') }}</h6>
                    @if (!empty($contract->fridge_calibration) && $contract->fridge_calibration !== '-')
                        <h3 class="mb-0">{{ $contract->fridge_calibration ? Carbon::parse($contract->fridge_calibration)->format('d/m/Y') : 'N/A' }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
        ...
        <div class="col-lg-4 col-6">
            <div class="card">
                <div class="card-body" style="min-height: 180px;">
                    ...
                    <h6 class="mb-3 mt-4">{{ __('Tail lift Loler') }}</h6>
                    @if (!empty($contract->tail_lift_loler) && $contract->tail_lift_loler !== '-')
                        <h3 class="mb-0">{{ $contract->tail_lift_loler ? Carbon::parse($contract->tail_lift_loler)->format('d/m/Y') : 'N/A' }}</h3>
                    @else
                        <h3 class="mb-0">-</h3>
                    @endif
                </div>
                  ...
                  <div class="card-body pt-0" style="margin-bottom: -30px; margin-top: -10px;">
                     <address class="mb-0 text-sm">
                        <dl class="row mt-4 align-items-center">
                           <h5>{{ __('Vehicle Enquiry Detail') }}</h5>
                           <br>
                           <div class="col-sm-6" style"font-size: 0.85rem !important;"> <!-- New Box -->
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Company Name')}}:</span> <span class="col-sm-8 text-sm">{{ !empty($contract->types) ? ucwords(strtoupper($contract->types->name)) : '' }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Vehicle Registration Number')}}:</span> <span class="col-sm-8 text-sm">{{$contract->registrationNumber }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Tax Status')}}:</span> <span class="col-sm-8 text-sm">{{$contract->taxStatus }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm">
                              <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Tax Due Date') }}:</span>
                              <span class="col-sm-8 text-sm">
                              {{ $contract->taxDueDate ? Carbon::parse($contract->taxDueDate)->format('d/m/Y') : 'N/A' }}
                              </span>
                           </dt>
                           <!--<dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Tax Due Date')}}:</span> <span class="col-sm-8 text-sm">{{ Auth::user()->dateFormat($contract->taxDueDate) }}</span></dt>-->
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('MOT Status')}}:</span> <span class="col-sm-8 text-sm">{{$contract->motStatus }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Make')}}:</span> <span class="col-sm-8 text-sm">{{$contract->make }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Year Of Manufacture')}}:</span> <span class="col-sm-8 text-sm">{{$contract->yearOfManufacture }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Engine Capacity')}}:</span> <span class="col-sm-8 text-sm">{{$contract->engineCapacity }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('CO2 Emissions')}}:</span> <span class="col-sm-8 text-sm">{{$contract->co2Emissions }}</span></dt>
                                             <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Insurance Type')}}:</span> <span class="col-sm-8 text-sm">{{ implode(', ', json_decode($contract->insurance_type, true) ?? []) }}</span></dt>

                           <dt class="col-sm-14 h6 text-sm">
                              <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Insurance') }}:</span>
                              <span class="col-sm-8 text-sm">
                              {{ $contract->insurance ? Carbon::parse($contract->insurance)->format('d/m/Y') : 'N/A' }}
                              </span>
                           </dt>
                           <dt class="col-sm-14 h6 text-sm">
                              <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('PMI Due') }}:</span>
                              <span class="col-sm-8 text-sm">
                              {{ $contract->PMI_due ? Carbon::parse($contract->PMI_due)->format('d/m/Y') : 'N/A' }}
                              </span>
                           </dt>
                           <dt class="col-sm-14 h6 text-sm">
                              <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Brake Test Due') }}:</span>
                              <span class="col-sm-8 text-sm">
                              {{ $contract->brake_test_due ? Carbon::parse($contract->brake_test_due)->format('d/m/Y') : 'N/A' }}
                              </span>
                           </dt>
                           <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Odometer Reading')}}:</span> <span class="col-sm-8 text-sm">{{$contract->odometer_reading }}</span></dt>
                           <dt class="col-sm-14 h6 text-sm">
                            <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Fridge Service') }}:</span>
                            <span class="col-sm-8 text-sm">
                            {{ $contract->fridge_service ? Carbon::parse($contract->fridge_service)->format('d/m/Y') : 'N/A' }}
                            </span>
                         </dt>
                         <dt class="col-sm-14 h6 text-sm">
                            <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Tail lift') }}:</span>
                            <span class="col-sm-8 text-sm">
                            {{ $contract->tail_lift ? Carbon::parse($contract->tail_lift)->format('d/m/Y') : 'N/A' }}
                            </span>
                         </dt>
                         <dt class="col-sm-14 h6 text-sm">
                            <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __(' Loler') }}:</span>
                            <span class="col-sm-8 text-sm">
                            {{ $contract->lorer ? Carbon::parse($contract->lorer)->format('d/m/Y') : 'N/A' }}
                            </span>
                         </dt>
                  </div>
                  <!-- End of New Box -->
                  <div class="col-sm-6"> <!-- Existing Boxes -->
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Fuel Type')}}:</span> <span class="col-sm-8 text-sm">{{$contract->fuelType }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Marked For Export')}}:</span> <span class="col-sm-8 text-sm">{{$contract->markedForExport }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Colour')}}:</span> <span class="col-sm-8 text-sm">{{$contract->colour }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Type Approval')}}:</span> <span class="col-sm-8 text-sm">{{$contract->typeApproval }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Revenue Weight')}}:</span> <span class="col-sm-8 text-sm">{{$contract->revenueWeight }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Euro Status')}}:</span> <span class="col-sm-8 text-sm">{{$contract->euroStatus }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm">
                  <span style="font-weight: bold; font-size: 0.85rem !important;">{{ __('Date Of Last V5C Issued') }}:</span>
                  <span class="col-sm-8 text-sm">
                  {{ $contract->dateOfLastV5CIssued ? Carbon::parse($contract->dateOfLastV5CIssued)->format('d/m/Y') : 'N/A' }}
                  </span>
                  </dt>
                  <!--<dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Date Of Last V5C Issued')}}:</span> <span class="col-sm-8 text-sm">{{ $contract->dateOfLastV5CIssued }}</span></dt>-->
<dt class="col-sm-14 h6 text-sm">
    ...
    <span class="col-sm-8 text-sm">
        @if($vehicle && $vehicle->annual_test_expiry_date)
            {{ Carbon::parse($vehicle->annual_test_expiry_date)->format('d/m/Y') }}
        @else
            {{ 'N/A' }}
        @endif
    </span>
</dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Wheelplan')}}:</span> <span class="col-sm-8 text-sm">{{$contract->wheelplan }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Month Of First Registration')}}:</span> <span class="col-sm-8 text-sm">{{$contract->monthOfFirstRegistration }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Tacho Calibration')}}:</span> <span class="col-sm-8 text-sm">{{$contract->tacho_calibration }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('DVS/PSS Permit Expiry')}}:</span> <span class="col-sm-8 text-sm">{{$contract->dvs_pss_permit_expiry }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Date Of Inspection')}}:</span> <span class="col-sm-8 text-sm"> {{ $contract->date_of_inspection ? Carbon::parse($contract->date_of_inspection)->format('d/m/Y') : 'N/A' }}</span></dt>
                  <dt class="col-sm-14 h6 text-sm"><span style="font-weight: bold; font-size: 0.85rem !important;">{{__('Fridge Calibration')}}:</span> <span class="col-sm-8 text-sm"> {{ $contract->fridge_calibration ? Carbon::parse($contract->fridge_calibration)->format('d/m/Y') : 'N/A' }}</span></dt>
