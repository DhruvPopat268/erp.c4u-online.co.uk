            ...
            <div>
                <div class="card mt-5" id="printTable" style="margin-left: 180px;margin-right: -57px;">
                    ...
                    <div class="row invoice-title mt-2">
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 " style="margin-left: 8%;" >
                            ...
                            <div class="row align-items-center mb-4">
                                <div class="col-sm-6 mb-3 mb-sm-0 mt-3">
                                    <h3 style="margin-left: 8%;">{{ __('DVLA Vehicle Information ') }}</h3>
                                    <div class="col-lg-12 col-md-8 mb-3" style="margin-left: 8%;">
                                        <h6 class="d-inline-block m-0 d-print-none">{{__('Company Name:')}}</h6>
                                        <span class="col-md-8"><span class="text-md">
{{strtoupper($contract->types->name) }}</span></span>
                                    </div>
                                    <div class="col-lg-6 col-md-8" style="margin-left: 8%;">
...
<div class="" style="margin-left: 8%;">
    ...
    <span class="col-md-8">
        <span class="text-md">
            {{ $contract->date_of_inspection ? Carbon::parse($contract->date_of_inspection)->format('d/m/Y') : 'N/A' }}
        </span>
    </span>
</div>
<div class="" style="margin-left: 8%;">
    ...
    <span class="col-md-8">
        <span class="text-md">
            {{ $contract->odometer_reading }}
                            ...
                            <div class="col-xxl-5" style="width: 100%; padding: 32px 27px 93px 17px;">
                        <div class="card report_card total_amount_card" style="padding: 32px 27px 93px 17px;">
                                <div class="card-body pt-0" style="margin-bottom: 30px; margin-top: 60%; ">
                                 <h3>{{ __('Vehicle Annual Test Report') }}</h3>
                            <div style="margin-top:3%; padding: 3px 2px 120px 17px;">
