{{ Form::model($contract, array('route' => array('trailer.update', $contract->id), 'method' => 'PUT')) }}
...
<!--</div>-->
 ...
 <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12" id="pmi_interval_wrapper">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('group_id', ['' => __('Select a company first')], $contract->group_id, ['class' => 'form-control']) }}
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            @if($contract->vehicle->annual_test_expiry_date)
