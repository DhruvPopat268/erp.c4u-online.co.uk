        ...
        @if (
            ...
            <li
                ...
                <a href="#!" class="dash-link"><span class="dash-micon"><i
                        ...
                        class="dash-mtext">{{ __('Company') }}</span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                <ul
            ...
            @endif
             <li class="dash-item {{ Request::segment(1) == 'driver' ? 'show' : '' }}">
                @role('company')
                    <a class="dash-link" href="{{ route('driver.apilogs') }}">{{ __('Driver ADD API Logs') }}</a>
                @endrole
            </li>
    </ul>
    </li>
...
@if (
    ...
    <li
        ...
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                ...
                class="dash-mtext">{{ __('Depot Management') }}</span><span class="dash-arrow"><i
                    data-feather="chevron-right"></i></span></a>
        <ul
    ...
    @if (
        ...
        <li
            ...
            <a class="dash-link"
                href="{{ route('depot.index') }}   ">{{ __('Manage Depot') }}</a>
...
@if (
    ...
    <li
        ...
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                ...
                class="dash-mtext">{{ __('Driver Management') }}</span><span class="dash-arrow"><i
                    data-feather="chevron-right"></i></span></a>
        <ul
        ...
        <li
            ...
            <a class="dash-link"
                href="{{ route('group.index') }}   ">{{ __('Manage Groups') }}</a>
    ...
    @if (
        ...
        <li
            ...
            <a class="dash-link"
                href="{{ route('driver.index') }}   ">{{ __('Manage Drivers') }}</a>
    ...
    <li
        ...
        <a class="dash-link"
            href="{{ route('driver-consent-form.index') }}   ">{{ __('Driver Consent Form') }}</a>
                ...
                @if (
                    ...
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Vehicle Management') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul
                            ...
                            @endcan  --}}
                             @can('manage vehicle')
                                <li
                                    class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('vehicle.group.index') }}">{{ __('Manage Vehicle Group') }}</a>
                                </li>
                    @endif
                            @can('manage vehicle')
                                <li
                                    class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('contract.index') }}">{{ __('Manage Vehicles') }}</a>
                                </li>
                    @endif
                    ...
                    <li
                        class="dash-item">
                        <a class="dash-link"
                            href="{{ route('fleet.index') }}">{{ __('Forward Planner') }}</a>
                    </li>
        @endif
        ...
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'training' ? 'show' : '' }}">
            ...
            <ul class="dash-submenu {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                ...
                <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('trainingTypes.index') }}">{{ __('Training Type') }}</a>
                </li>
                 @endcan
                @if (Gate::check('manage trainings'))
                 <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                     <a class="dash-link" href="{{ route('training.index') }}">{{ __('Training PDP') }}</a>
                 </li>
                  @endcan
                                  @if (Gate::check('manage view training'))
                 <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                      <a class="dash-link" href="{{ route('training.history.index') }}">{{ __('Training Log') }}</a>
                  </li>
                   @endcan
        ...
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
            ...
            <ul class="dash-submenu {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                ...
                @if (Gate::check('show assign policy'))
                  ...
                  <li class="dash-item {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('fors.assignpolicy.view') }}">{{ __('Policy Log') }}</a>
                </li>
                @endcan
        ...
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
            ...
            <ul class="dash-submenu {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
               ...
               @endcan
                ...
                <li class="dash-item {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('profile.index') }}">{{ __('WalkAround Profile') }}</a>
                </li>
                 @endcan
                @if (Gate::check('manage contactbook'))
                <li class="dash-item {{ Request::segment(1) == 'workaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('contactbook.index') }}">{{ __('Contact Book') }}</a>
                </li>
                  @endcan
                                  @if (Gate::check('manage viewwalkaround'))
                 <li class="dash-item {{ Request::segment(1) == 'workaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('viewworkaround.index') }}">{{ __('Walkaround Log') }}</a>
                </li>
                  @endcan
...
@if (
    ...
    <li
        ...
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                ...
                class="dash-mtext">{{ __('Report Management') }}</span><span class="dash-arrow"><i
                    data-feather="chevron-right"></i></span></a>
        <ul
...
@if (
    ...
    <li
        ...
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                ...
                class="dash-mtext">{{ __('Newsletter') }}</span><span class="dash-arrow"><i
                    data-feather="chevron-right"></i></span></a>
        <ul
                ...
                <ul class="dash-submenu">
                    ...
                    @can('manage role')
                        <li
                            ...
                            <a class="dash-link" href="{{ route('roles.index') }}">{{ __('Access Level') }}</a>
                        </li>
                    @endcan
                    {{--  @can('manage client')
                        <li
