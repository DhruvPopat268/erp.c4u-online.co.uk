...
.dash-sidebar {
    ...
    scrollbar-color: transparent transparent; /* Set thumb and track colors to transparent */
}
</style>
...
@endif
<div class="navbar-wrapper" style="width:111%">
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
            ...
            @else
                <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') }}"ve
                    alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg">
            @endif
                ...
                @if (Gate::check('show dashboard'))
                    <li
                        class="dash-item dash-hasmenu">
                                    <a href="{{ route('crm.dashboard') }}" class="dash-link {{ Request::segment(1) == 'crm-dashboard' || Request::segment(1) == 'reports-lead' || Request::segment(1) == 'reports-deal' ? ' active' : '' }}">
 ...
 @if (!empty($userPlan) &&  $userPlan->crm == 1)
        @if (
            ...
            <li
                class="dash-item dash-hasmenu {{ Request::segment(1) == 'contractType' ? 'show' : '' }}">
                <a href="#!" class="dash-link"><span class="dash-micon"><i
                            class="ti ti-building"></i></span><span
                        class="dash-mtext">{{ __('Company') }}</span></a>
                <ul
                    class="dash-submenu {{ Request::segment(1) == 'contractType' ? 'show' : '' }}">


            @if (
                    Gate::check('manage company'))
                <li
                    class="dash-item {{ Request::segment(1) == 'contractType' ? 'show' : '' }}">
                    <a class="dash-link "
                        href="{{ route('contractType.index') }}   ">{{ __('Manage Company') }}</a>

                </li>
            @endif
             <li class="dash-item {{ Request::segment(1) == 'driver' ? 'show' : '' }}">
                @role('company')
                    <a class="dash-link" href="{{ route('driver.apilogs',['company_id' => request('company_id')]) }}">{{ __('Driver ADD API Logs') }}</a>
                @endrole
            </li>
    </ul>
    </li>
...
@if (!empty($userPlan) &&  $userPlan->crm == 1)
@if (
        Gate::check('manage depot'))
    <li
        class="dash-item dash-hasmenu {{ Request::segment(1) == 'depot'  ? ' active dash-trigger' : '' }}">
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                    class="fas fa-warehouse" style='font-size:15px'></i></span><span
                class="dash-mtext">{{ __('Depot Management') }}</span></a>
        <ul
            class="dash-submenu {{ Request::segment(1) == 'depot' ? 'show' : '' }}">
    @if (
            Gate::check('manage depot'))
        <li
            class="dash-item  {{ Request::segment(1) == 'depot' ? 'active dash-trigger' : '' }}">
            <a class="dash-link"
                href="{{ route('depot.index',['company_id' => request('company_id')]) }}   ">{{ __('Manage Depot') }}</a>
...
@if (
    ...
    <li
        class="dash-item dash-hasmenu {{ Request::segment(1) == 'driver' ? 'show' : '' }}">
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                    class="ti ti-steering-wheel" style="color: #000;"></i></span><span
                class="dash-mtext">{{ __('Driver Management') }}</span></a>
        <ul
            class="dash-submenu {{ Request::segment(1) == 'driver' ? 'show' : '' }}">
              @if (
            Gate::check('manage driver'))
        <li
            class="dash-item  {{ Request::segment(1) == 'group' ? 'show' : '' }}">
            <a class="dash-link"
                href="{{ route('group.index',['company_id' => request('company_id')]) }}   ">{{ __('Manage Groups') }}</a>
    ...
    @if (
            Gate::check('manage driver'))
        <li
            class="dash-item  {{ Request::segment(1) == 'driver' ? 'show' : '' }}">
            <a class="dash-link"
                href="{{ route('driver.index',['company_id' => request('company_id')]) }}   ">{{ __('Manage Drivers') }}</a>
    ...
    @endif
     @if (
        Gate::check('manage driver'))
    <li
        class="dash-item  {{ Request::segment(1) == 'consent' ? 'show' : '' }}">
        <a class="dash-link"
            href="{{ route('driver-consent-form.index',['company_id' => request('company_id')]) }}   ">{{ __('Driver Consent Form') }}</a>
...
@endif
      ...
      <!--------------------- Start Vehicle ----------------------------------->
            ...
            @if (!empty($userPlan) &&  $userPlan->crm == 1)
                @if (
                    ...
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-truck"></i></span><span
                                class="dash-mtext">{{ __('Vehicle Management') }}</span></a>
                        <ul
                            ...
                            @endcan  --}}
                             @can('manage vehicle')
                                <li
                                    class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('vehicle.group.index',['company_id' => request('company_id')]) }}">{{ __('Manage Vehicle Group') }}</a>
                                </li>
                    @endif
                            @can('manage vehicle')
                                <li
                                    class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('contract.index',['company_id' => request('company_id')]) }}">{{ __('Manage Vehicles') }}</a>
                                </li>
                    @endif
                    ...
                    <li
                        class="dash-item">
                        <a class="dash-link"
                            href="{{ route('fleet.index',['company_id' => request('company_id')]) }}">{{ __('Forward Planner') }}</a>
                    </li>
        @endif
                ...
                @can('manage planner')
                    <li
                        class="dash-item">
                        <a class="dash-link"
                            href="{{ route('planner.history.index',['company_id' => request('company_id')]) }}">{{ __('Planner Log') }}</a>
                    </li>
        @endif
        ...
        @if (!empty($userPlan) && $userPlan->crm == 1)
    @if (Gate::check('manage training types')  || Gate::check('manage trainings') || Gate::check('manage view training') )
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'training' ? 'show' : '' }}">
            <a href="#!" class="dash-link">
                <span class="dash-micon"><i class='fas fa-chalkboard-teacher' style='font-size:15px'></i></span>
                <span class="dash-mtext">{{ __('Training Management') }}</span>

            </a>
            <ul class="dash-submenu {{ Request::segment(1) == 'training' ? 'show' : '' }}">

                @if (Gate::check('manage training types'))
                <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('trainingTypes.index',['company_id' => request('company_id')]) }}">{{ __('Training Type') }}</a>
                </li>
                 @endcan
                @if (Gate::check('manage trainings'))
                 <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                     <a class="dash-link" href="{{ route('training.index',['company_id' => request('company_id')]) }}">{{ __('Training PDP') }}</a>
                 </li>
                  @endcan
                                  @if (Gate::check('manage view training'))
                 <li class="dash-item {{ Request::segment(1) == 'training' ? 'show' : '' }}">
                      <a class="dash-link" href="{{ route('training.history.index',['company_id' => request('company_id')]) }}">{{ __('Training Log') }}</a>
                  </li>
                   @endcan
...
@if (!empty($userPlan) && $userPlan->crm == 1)
    @if (Gate::check('manage fors') || Gate::check('manage assign policy'))
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
            <a href="#!" class="dash-link">
                <span class="dash-micon"><i class="fas fa-file-contract"></i></span>
                <span class="dash-mtext">{{ __('Driver Handbook') }}</span>

            </a>
            <ul class="dash-submenu {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                                @if (Gate::check('create fors'))

                <li class="dash-item {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('fors.bronze.index') }}">{{ __('Policies') }}</a>
                </li>
                                @endcan

                @if (Gate::check('manage assign policy'))

                <li class="dash-item {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('fors.assignpolicy.index') }}">{{ __('Assign Policy') }}</a>
                </li>
                @endcan
                @if (Gate::check('show assign policy'))

                  <li class="dash-item {{ Request::segment(1) == 'fors' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('fors.assignpolicy.view',['company_id' => request('company_id')]) }}">{{ __('Policy Log') }}</a>
                </li>
                @endcan
    ...
    <!--@if (Gate::check('manage assign policy') && auth()->user()->hasRole('Companies'))-->
    <!--    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'fors' ? 'show' : '' }}">-->
    <!--        <a href="#!" class="dash-link">-->
    <!--            <span class="dash-micon"><i class="fas fa-file-contract"></i></span>-->
    <!--            <span class="dash-mtext">{{ __('Policy') }}</span>-->
    ...
    <!--             <li class="dash-item {{ Request::segment(1) == 'fors' ? 'show' : '' }}">-->
    <!--                <a class="dash-link" href="{{ route('fors.assignpolicy.view') }}">{{ __('View Assign Policy') }}</a>-->
    <!--            </li>-->
    <!--            @endcan-->
    <!--        </ul>-->
    <!--    </li>-->
...
@if (!empty($userPlan) && $userPlan->crm == 1)
    @if (Gate::check('manage profile') || Gate::check('manage contactbook') || Gate::check('manage question') )
        <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
            <a href="#!" class="dash-link">
                <span class="dash-micon"><i class="fa fa-car"></i></span>
                <span class="dash-mtext">{{ __('WalkAround') }}</span>

            </a>
            <ul class="dash-submenu {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
               @if (Gate::check('manage question'))
                <li class="dash-item {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('question.index') }}">{{ __('Description') }}</a>
                </li>
               @endcan
                @if (Gate::check('manage profile'))
                <li class="dash-item {{ Request::segment(1) == 'walkaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('profile.index',['company_id' => request('company_id')]) }}">{{ __('WalkAround Profile') }}</a>
                </li>
                 @endcan
                @if (Gate::check('manage contactbook'))
                <li class="dash-item {{ Request::segment(1) == 'workaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('contactbook.index',['company_id' => request('company_id')]) }}">{{ __('Contact Book') }}</a>
                </li>
                  @endcan
                                  @if (Gate::check('manage viewwalkaround'))
                 <li class="dash-item {{ Request::segment(1) == 'workaround' ? 'show' : '' }}">
                    <a class="dash-link" href="{{ route('viewworkaround.index',['company_id' => request('company_id')]) }}">{{ __('Walkaround Log') }}</a>
                </li>
                  @endcan
...
@if (!empty($userPlan) &&  $userPlan->crm == 1)
@if (
        Gate::check('manage pcn'))
    <li
        class="dash-item dash-hasmenu {{ Request::segment(1) == 'pcn'  ? ' active dash-trigger' : '' }}">
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                    class="fa fa-file" style='font-size:15px'></i></span><span
                class="dash-mtext">{{ __('PCN Management') }}</span></a>
        <ul
            class="dash-submenu {{ Request::segment(1) == 'pcn' ? 'show' : '' }}">
    @if (
            Gate::check('manage pcn'))
        <li
            class="dash-item  {{ Request::segment(1) == 'pcn' ? 'active dash-trigger' : '' }}">
            <a class="dash-link"
                href="{{ route('pcn.index',['company_id' => request('company_id')]) }}   ">{{ __('Manage PCN') }}</a>
...
@if (!empty($userPlan) &&  $userPlan->crm == 1)
@if (
        Gate::check('manage emailsend'))
    <li
        class="dash-item dash-hasmenu {{ Request::segment(1) == 'email' ? 'show' : '' }}">
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                    class="fa fa-envelope" style="color: #000;"></i></span><span
                class="dash-mtext">{{ __('Report Management') }}</span></a>
        <ul
            class="dash-submenu {{ Request::segment(1) == 'email' ? 'show' : '' }}">

          @can('manage emailsend')
        <li
            class="dash-item  {{ Request::segment(1) == 'email' ? 'show' : '' }}">
            <a class="dash-link"
                href=" {{ route('weeklyemailsender') }}  ">{{ __('Weekly Email Report') }}</a>
        ...
        <li
            class="dash-item  {{ Request::segment(1) == 'email' ? 'show' : '' }}">
            <a class="dash-link"
                href=" {{ route('monthlyemailsender') }}  ">{{ __('Monthly  Email Report') }}</a>
...
@if (!empty($userPlan) &&  $userPlan->crm == 1)
@if (
        Gate::check('manage newsletter'))
    <li
        class="dash-item dash-hasmenu {{ Request::segment(1) == 'news' ? 'show' : '' }}">
        <a href="#!" class="dash-link"><span class="dash-micon"><i
                    class="far fa-newspaper" ></i></span><span
                class="dash-mtext">{{ __('Newsletter') }}</span></a>
        <ul
            class="dash-submenu {{ Request::segment(1) == 'news' ? 'show' : '' }}">

        <li
            class="dash-item  {{ Request::segment(1) == 'news' ? 'show' : '' }}">
            <a class="dash-link"
                href=" {{ route('newsletter.index') }}  ">{{ __('Newsletter') }}</a>
        ...
        @if (
            ...
            <li
                ...
                <ul class="dash-submenu">
                    @can('manage user')
                        <li
                            ...
                            <a class="dash-link" href="{{ route('users.index',['company_id' => request('company_id')]) }}">{{ __('User') }}</a>
                        </li>
                    @endcan
                    @can('manage role')
                        <li
                            ...
                            <a class="dash-link" href="{{ route('roles.index') }}">{{ __('Web Access Level') }}</a>
                        </li>
                    @endcan
                    @if (
                    Gate::check('manage company'))
                <li
                    class="dash-item">
                    <a class="dash-link "
                        href="{{ route('accesslevel.index') }}   ">{{ __('Mobile App Access Level') }}</a>
