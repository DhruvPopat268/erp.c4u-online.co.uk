...
<div class="navbar-wrapper" style="width:111%">
 ...
 @if (!empty($userPlan) &&  $userPlan->crm == 1)
           @if (Gate::check('manage company') || Gate::check('manage credit logs'))
            ...
            @endif
             ...
             @if (Gate::check('manage credit logs'))
                    <li class="dash-item">
                        <a class="dash-link" href="{{ route('credit-coins.index') }}">
                            {{ __('ADD API Credit Logs') }}
                        </a>
                    </li>
               @endif
    </ul>
...
@if (!empty($userPlan) &&  $userPlan->crm == 1)
    <li class="dash-item dash-hasmenu">
        <a href="#!" class="dash-link">
            <span class="dash-micon">
                <i class="fas fa-headset" style="font-size:15px"></i>
            </span>
        ...
        <ul class="dash-submenu">
            ...
            {{-- Knowledge Base --}}
            <li class="dash-item">
                <a class="dash-link" href="https://support.c4u-online.co.uk/" target="_blank">
                    {{ __('Knowledge Base') }}
                </a>
            </li>
            ...
            {{-- Support Ticket --}}
            <li class="dash-item">
                <a class="dash-link" href="https://support.c4u-online.co.uk/user/support/create_ticket" target="_blank">
                    {{ __('Support Ticket') }}
                </a>
            </li>
