{{ Form::model($driver, ['route' => ['driver.update', $driver->id], 'method' => 'PUT']) }}
    <div class="modal-body">
        ...
        {{ Form::date('driver_dob', $driverDOB, ['class' => 'form-control', 'id' => 'driver_dob', 'onchange' => 'calculateAge(this.value)']) }}
            ...
            <div class="form-group col-md-6">
                ...
                {{ Form::text('username', old('username', $driver->driverUser->username ?? ''), ['class' => 'form-control', 'required']) }}
            </div>
        </div>
       ...
       <div class="row">
        ...
        @endphp
        {{ Form::text('contact_no', $displayContactNo, ['class' => 'form-control','required' => 'required']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('contact_email', __('Contact Email')) }}
        {{ Form::text('contact_email', $driver->contact_email, array('class' => 'form-control','required' => 'required')) }}
    </div>
    ...
    <div class="row">
        ...
        {{ Form::select('group_id', ['' => __('Select a company first')], $driver->group_id, ['class' => 'form-control', 'required' => 'required']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('depot_id', __('Depot Name'), ['class' => 'form-label']) }}
        {{ Form::select('depot_id', ['' => __('Select a company first')], $driver->depot_id, ['class' => 'form-control', 'required' => 'required']) }}
    </div>
