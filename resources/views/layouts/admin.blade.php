...
.loader-content {
   background: rgba(255, 255, 255, 0.8);box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);border-radius: 10px;position: absolute; top: 50%; left: 50%;padding: 10px;
}

.white-box {
    width: 3rem; height: 3rem;color: #ffffff;
}
...
.loader-track {
    ...
    border-radius: 50%;
    border: 4px solid rgb(78, 78, 78); /* Full black border */
    border-top: 4px solid transparent; /* Create the blank effect */
