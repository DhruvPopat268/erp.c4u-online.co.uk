...
height:300;
            $.ajax({
                url: "{{route('bronze.policy_description.store',$forsBronze->id)}}",
                data: {_token: $('meta[name="csrf-token"]').attr('content'), bronze_policy_description: $(this).val()},
                type: 'POST',
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('fors.bronze.index') }}">{{ __('Policy') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{$forsBronze->bronze_policy_name}}</li>
@endsection
...
<!--@if((\Auth::user()->type=='company'))-->
<!--<a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-size="lg" data-url="{{ route('Bronzesignature',$forsBronze->id) }}"-->
<!--   data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{__('Add signature')}}" class="btn btn-sm btn-primary">-->
<!--    <i class="ti ti-pencil text-white"></i>-->
<!--</a>-->
<!--@endif-->
...
<div class="row">
   <!--<div class="col-xl-3">-->
   <!--    <div class="card sticky-top" style="top:30px; width:61%;">-->
   ...
   <!--    </div>-->
   <!--</div>-->
   <div class="col-xl-13" style="">
       <div id="useradd-1">

           <div class="card">
               <div class="card-header">
                   <h5 class="mb-0">{{ __('Policy Description - ')  }} {{$forsBronze->bronze_policy_name}}</h5>
               </div>
               <div class="card-body" >
                   <div class="col-md-12">
                       <div class="form-group mt-3" >
                           <p style="color:red;"> Used Parameter For Company Name : {companyname}</P>
                           <textarea class="summernote-simple" >{!! $forsBronze->bronze_policy_description !!}</textarea>
                       </div>
                   </div>
               </div>
           </div>
    ...
    <!--            <a href="{{ route('Bronzeaccept.download_pdf', ['id' => $forsBronze->id]) }}" class="btn btn-sm btn-success mb-3">-->
    <!--                <i class="ti ti-download"></i>-->
    <!--            </a>-->
    <!--            </div>-->
    <!--        </div>-->
    ...
    <!--                <a href="{{ route('BronzeDecline.download_pdf', ['id' => $forsBronze->id]) }}" class="btn btn-sm btn-success mb-3">-->
    <!--                    <i class="ti ti-download"></i>-->
    <!--                </a>-->
    <!--                </div>-->
    <!--        </div>-->
