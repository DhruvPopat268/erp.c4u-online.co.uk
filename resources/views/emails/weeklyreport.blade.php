<div style="box-sizing:border-box;margin:0;font-family:Roboto,Arial,Helvetica,Verdana;font-size:17px;font-weight:400;line-height:1.8;color:#212529;text-align:left;background-color:#fff">
    <p style="box-sizing:border-box;margin-top:0;margin-bottom:1rem"><strong style="box-sizing:border-box;font-weight:bolder">Dear {{ $companyData['companyName'] }},</strong><br style="box-sizing:border-box"><br style="box-sizing:border-box">
       <span style="font-size:10pt;box-sizing:border-box">Please find attached reports for the
       above-mentioned period.</span><br style="box-sizing:border-box"><span style="font-size:10pt;box-sizing:border-box">Kindly accept and process the
       outstanding Infringements.</span><br style="box-sizing:border-box"><span style="font-size:10pt;box-sizing:border-box">Kindly check the driver card
       submission report and advise us about the status of the drivers or if there
       are any issues. Please notify us ASAP for any driver leaving or
       joining.</span><br style="box-sizing:border-box"><span style="font-size:10pt;box-sizing:border-box">If you have any questions, please do not hesitate
       to contact us.<br style="box-sizing:border-box"><br style="box-sizing:border-box"></span>
    </p>
    ...
    <p style="box-sizing:border-box;margin-top:0;margin-bottom:1rem"><span style="font-size:10pt;box-sizing:border-box">This email and any attachments
       ...
       received this email in error.</span>
    </p>
