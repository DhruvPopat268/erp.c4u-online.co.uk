...
public function createdCompanyDetails()
{
    return $this->hasMany(\App\Models\CompanyDetails::class, 'created_by');
}
public function createddepot()
{
    return $this->hasMany(\App\Models\Depot::class, 'created_by');
}
    ...
    {
        return $this->belongsTo(CompanyDetails::class, 'companyname'); // Adjust as needed
    }
    ...
    public function dateFormat($date)
    {
     ...
     public function dateFormaty($date)
    {
        $settings = Utility::settings();

        return date($settings['site_date_format'] = 'd F Y', strtotime($date));
    }
