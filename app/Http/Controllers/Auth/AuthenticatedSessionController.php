...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request)
    {
        ...
        // Check if the user's associated company is active (skip for company and super admin)
    if (!in_array($user->type, ['super admin', 'company'])) {
        ...
        if (!$company) {
            auth()->logout();
            return redirect()->back()->with('error', __('Your company account is not active. Please contact customer support.'));
        }
    }
        ...
        {
            auth()->logout();
                        return redirect()->back()->with('error', __('Your account has been temporarily restricted. Please contact customer support for assistance.'));
        }
