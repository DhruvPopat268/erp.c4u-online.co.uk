...
$(document).ready(function () {
    ...
    // Initialize select functionality with event delegation (works with or without DataTable)
...
function initializeSelectFunctionality() {
    // Use event delegation - this works regardless of DOM changes by DataTable
